...
const saveOrUpdatePsikotest = async (payload) => {
  ...
  const data = {
    ...
    skor_iq:
      skor_iq !== undefined && skor_iq !== null && skor_iq !== ""
        ? Number(skor_iq)
        : null,
    keterangan_iq: keterangan_iq || null,
    kepribadian: kepribadian || null,
    stabilitas_emosi: stabilitas_emosi || null,
    integritas: integritas || null,
    aspek_tambahan: Array.isArray(aspek_tambahan) ? aspek_tambahan : [],
    catatan: catatan || null,
    kesimpulan,
    skor_akhir: Number(skor_akhir),
    nama_pemeriksa_staff: nama_pemeriksa_staff || null,
    nama_pemeriksa_manager: nama_pemeriksa_manager || null,
...
const saveOrUpdateInterview = async (payload) => {
  ...
  const data = {
    ...
    usia: usia !== undefined && usia !== null && usia !== "" ? Number(usia) : null,
    pendidikan_terakhir: pendidikan_terakhir || null,
    pengalaman_kerja: pengalaman_kerja || null,
    bidang_pengalaman: bidang_pengalaman || null,
    jabatan_dilamar: jabatan_dilamar || "-",
    tanggal_wawancara: tanggal_wawancara
      ? new Date(tanggal_wawancara)
      : new Date(),
    penilaian: Array.isArray(penilaian) ? penilaian : [],
    kesimpulan,
    gaji_harapan: gaji_harapan || null,
    nama_pewawancara: nama_pewawancara || null,
    tanda_tangan_pewawancara: tanda_tangan_pewawancara || null,
    data_dokumen_pendukung: data_dokumen_pendukung || null,
    nama_dokumen_pendukung: nama_dokumen_pendukung || null,
    mime_dokumen_pendukung: mime_dokumen_pendukung || null,
    ukuran_dokumen_pendukung:
...
const mapPsikotestForClient = (h) => {
  ...
  return {
    ...
    penguji: h.penguji,
    skorIq: h.skor_iq,
    keteranganIq: h.keterangan_iq,
    kepribadian: h.kepribadian,
    stabilitasEmosi: h.stabilitas_emosi,
    integritas: h.integritas,
    aspekTambahan: h.aspek_tambahan,
    catatan: h.catatan,
    kesimpulan: h.kesimpulan,
    skorAkhir: h.skor_akhir,
    namaPemeriksaStaff: h.nama_pemeriksa_staff,
    namaPemeriksaManager: h.nama_pemeriksa_manager,
...
const mapInterviewForClient = (h) => {
  ...
  return {
    ...
    pengalamanKerja: h.pengalaman_kerja,
    bidangPengalaman: h.bidang_pengalaman,
    jabatanDilamar: h.jabatan_dilamar,
    tanggalWawancara: h.tanggal_wawancara,
    penilaian: h.penilaian,
    kesimpulan: h.kesimpulan,
    gajiHarapan: h.gaji_harapan,
    namaPewawancara: h.nama_pewawancara,
    tandaTanganPewawancara: h.tanda_tangan_pewawancara,
    dataDokumenPendukung: h.data_dokumen_pendukung,
    namaDokumenPendukung: h.nama_dokumen_pendukung,
    mimeDokumenPendukung: h.mime_dokumen_pendukung,
    ukuranDokumenPendukung: h.ukuran_dokumen_pendukung,

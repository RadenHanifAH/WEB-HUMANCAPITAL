export const API_URL_APPLICANTS = "https://web-humancapital-production.up.railway.app/api/applications";
export const API_URL_JOBS = "https://web-humancapital-production.up.railway.app/api/jobs";

  ...
  return (
    <Card>
      <div className="flex justify-between items-center p-6 pb-2">
        <div>
          <h3 className="text-lg font-semibold text-gray-800">Lowongan</h3>
          <p className="text-sm text-gray-500">{positionPeriod.label}</p>
        </div>
        <PeriodDropdown selected={positionPeriod} onChange={setPositionPeriod} />
      </div>
